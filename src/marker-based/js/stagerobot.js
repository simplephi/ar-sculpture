              ...
              if ($(this).is(':checked')) {
                  ...
                  if(entityMarker==1){
                   ...
                   var marsrobotMarker = document.createElement('a-entity');
                    ...
                    marsrobotMarker.object3D.scale.set(10, 10, 10);
                    marsrobotMarker.object3D.rotation.set(-90, 0, 0);
                     ...
                     markerEl.addEventListener("markerFound", ()=> {
                       ...
                       navigator.geolocation.getCurrentPosition(function(position) {
                           ...
                           var marsrobotGps = document.createElement('a-entity');
                            ...
                            marsrobotGps.setAttribute('gltf-model', '#stagerobot');
                            ...
                            marsrobotGps.object3D.scale.set(10, 10, 10);
